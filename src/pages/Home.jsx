  ...
  return (
    <>
      {/* <!-- hero start --> */}
                ...
                <div className="row align-items-center justify-content-xl-between justify-content-center">
                    <div className="col-xxl-7 col-xl-6 col-lg-10">
                        <div className="hero-content-2">
                            ...
                            <div className="title">
                                <h1>Find The Best Online
                                    Course For Skills</h1>
                            </div>
                            <div className="description">
                                <p>Objectively redefine out-of box technologies for multimedia based is online is
                                    networks.
                                    Proactively architect economically</p>
                            </div>
                    ...
                    <div className="col-xl-5 text-center mt-lg-50 mt-md-50 mt-xs-50">
                        <div className="hero-img-wrapper">
                            ...
                            <div className="happy-student-count-box aos-init" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div className="counter-wrapper">
                                    ...
                                    <div className="number">
                                        <h6 className="odometer odometer-auto-theme" data-count="14">
                                            <div className="odometer-inside"><span className="odometer-digit"><span
                                                    className="odometer-digit-spacer">8</span><span
                                                    className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                                    className="odometer-ribbon-inner"><span className="odometer-value">0</span></span></span></span></span>
                                            </div>
                                        </h6>
                                    </div>
            ...
            <div className="container">
                <div className="row text-center">
                    <div className="col-xl-12">
                        <div className="section-title mb-50 aos-init" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1 text-center justify-content-center">
                    <div className="col">
                        <div className="course-category-wrap aos-init" data-aos="fade-up" data-aos-delay="">
                            <div className="icon">
                    ...
                    <div className="col">
                        <div className="course-category-wrap aos-init" data-aos="fade-up" data-aos-delay="250">
                            <div className="icon">
                    ...
                    <div className="col">
                        <div className="course-category-wrap aos-init" data-aos="fade-up" data-aos-delay="300">
                            <div className="icon">
                    ...
                    <div className="col">
                        <div className="course-category-wrap aos-init" data-aos="fade-up" data-aos-delay="350">
                            <div className="icon">
                    ...
                    <div className="col">
                        <div className="course-category-wrap aos-init" data-aos="fade-up" data-aos-delay="400">
                            <div className="icon">
                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-xl-6 col-lg-6 col-md-9 mb-lg-50 mb-md-50 mb-xs-50">
                        <div className="about-img-wrapper-2">
                            ...
                            <div className="about-img-2 d-none d-xl-inline-block aos-init" data-aos="zoom-in"
                                 data-aos-delay="200">
                                <img src="assets/img/about/about-3.jpg" alt="thumb" />
                            </div>
                            <div className="experience-box text-center aos-init" data-aos="fade-up" data-aos-delay="200">
                                <div className="text-content text-start mb-10">
                                    <span><img src="assets/img/icon/experience.svg" alt="icon" /></span>
                                    <h4>25
                                        Years</h4>
                                </div>
                    ...
                    <div className="col-xl-6 col-lg-6">
                        <div className="about-content-2 aos-init" data-aos="fade-left" data-aos-delay="200">
        ...
        {/* <!-- Counter start --> */}
        <div className="counter-section-2 pt-80 pb-30 pt-xs-60 pb-xs-10 aos-init" data-aos="fade-up" data-aos-delay="200">
            <div className="container">
                <div className="row">
                    <div className="col-xl-3 col-md-6">
                        <div className="counter-wrap-2 justify-content-xl-start justify-content-center mb-50">
                            ...
                            <div className="counter-info">
                                <div className="number">
                                    <h3 className="odometer odometer-auto-theme" data-count="14,500">
                                        <div className="odometer-inside"><span className="odometer-digit"><span
                                                className="odometer-digit-spacer">8</span><span
                                                className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                                className="odometer-ribbon-inner"><span
                                                className="odometer-value">0</span></span></span></span></span></div>
                                    </h3>
                                </div>
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="counter-wrap-2 justify-content-xl-start justify-content-center mb-50">
                            ...
                            <div className="counter-info">
                                <div className="number">
                                    <h3 className="odometer odometer-auto-theme" data-count="569">
                                        <div className="odometer-inside"><span className="odometer-digit"><span
                                                className="odometer-digit-spacer">8</span><span
                                                className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                                className="odometer-ribbon-inner"><span
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="counter-wrap-2 justify-content-xl-start justify-content-center mb-50">
                            ...
                            <div className="counter-info">
                                <div className="number">
                                    <h3 className="odometer odometer-auto-theme" data-count="32,500">
                                        <div className="odometer-inside"><span className="odometer-digit"><span
                                                className="odometer-digit-spacer">8</span><span
                                                className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                                className="odometer-ribbon-inner"><span
                    ...
                    <div className="col-xl-3 col-md-6">
                        <div className="counter-wrap-2 justify-content-xl-start justify-content-center mb-50">
                            ...
                            <div className="counter-info">
                                <div className="number">
                                    <h3><span className="odometer odometer-auto-theme" data-count="32"><div
                                            className="odometer-inside"><span className="odometer-digit"><span
                                            className="odometer-digit-spacer">8</span><span
                                            className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                            className="odometer-ribbon-inner"><span
                                            className="odometer-value">0</span></span></span></span></span></div></span>K
                                    </h3>
                                </div>
                                <div className="counter-info-divider mt-15 mb-15"></div>
                                <div className="text">
        ...
        <div className="course-section-2 pt-150 pb-150 pt-lg-120 pb-lg-120 pt-md-80 pb-md-80 pt-xs-50 pb-xs-50">
            <div className="container">
                <div className="row">
                    <div className="col-xl-12">
                        <div className="section-title text-center mb-50 aos-init" data-aos="fade-up">
                            <div className="sub-title mb-10">
                                <p>Top Course</p>
                            </div>
                            <div className="title">
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="">
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="200">
                            <div className="course-img">
                                <img src="assets/img/course/course-thumb-8.jpg" alt="course" />
                            </div>
                            <div className="category">
                                <div className="btn-1">
                                    <a href="#">Language</a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="250">
                            <div className="course-img">
                                <img src="assets/img/course/course-thumb-9.jpg" alt="course" />
                            </div>
                            <div className="category">
                                <div className="btn-1">
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="300">
                            <div className="course-img">
                                <img src="assets/img/course/course-thumb-10.jpg" alt="course" />
                            </div>
                            <div className="category">
                                <div className="btn-1">
                                    <a href="#">Internet</a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="350">
                            <div className="course-img">
                                <img src="assets/img/course/course-thumb-11.jpg" alt="course" />
                            </div>
                            <div className="category">
                                <div className="btn-1">
                                    <a href="#">Webflow</a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="course-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="400">
                            <div className="course-img">
                                <img src="assets/img/course/course-thumb-12.jpg" alt="course" />
                            </div>
                            <div className="category">
                                <div className="btn-1">
                                    <a href="#">Design</a>
            ...
            <div className="container">
                ...
                <div className="row align-items-center">
                    <div className="col-md-6">
                        <div className="career-wrap aos-init" data-aos="fade-up" data-aos-delay="300">
                            <div className="thumb">
                                <img src="assets/img/career/career-thumb-1.png" alt="career" />
                            </div>
                            <div className="content">
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="choose-content-2 mb-30 aos-init" data-aos="fade-right">
                            <div className="section-title">
                                <div className="sub-title mb-10">
                                    <p>Why Choose Us</p>
                                </div>
                            ...
                            <div className="text">
                                <p>Rapidiously iterate enabled meta-services vis-a-vis world-class quality vectors.
                                    Collaboratively recaptiualize future-proof relationships via ubiquitous
                                    leadership.
                                </p>
                            </div>
                            <div className="list">
                            ...
                            <div className="choose-btn-2">
                                ...
                                <div className="play-btn">
                                    <a href="https://www.youtube.com/watch?v=O5TdnuUhIgs&amp;ab_channel=Webflow"
                                       className="open-popup-video vbox-item" data-autoplay="true" data-vbtype="video">
                                            <span className="icon">
                    ...
                    <div className="col-lg-6">
                        <div className="choose-thumb-2 text-center mb-30">
                            ...
                            <div className="thumb-2 d-none d-xl-inline-block aos-init" data-aos="zoom-in">
                            ...
                            <div className="student-thumbs">
                                ...
                                <div className="student-thumbs-box">
                                    <span><img src="assets/img/chose/st-1.jpg" alt="thumb" /></span>
                                    <span><img src="assets/img/chose/st-2.jpg" alt="thumb" /></span>
                                    <span><img src="assets/img/chose/st-3.jpg" alt="thumb" /></span>
                                    <span><img src="assets/img/chose/st-4.jpg" alt="thumb" /></span>
                            ...
                            <div className="course-count-section">
                                <div className="course-count">
                                    <div className="number">
                                        <h6 className="odometer odometer-auto-theme" data-count="535">
                                            <div className="odometer-inside"><span className="odometer-digit"><span
                                                    className="odometer-digit-spacer">8</span><span
                                                    className="odometer-digit-inner"><span className="odometer-ribbon"><span
                                                    className="odometer-ribbon-inner"><span className="odometer-value">0</span></span></span></span></span>
            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div className="col-xl-3 col-lg-4 col-md-6">
                        <div className="instructor-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="200">
                            <div className="thumb">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6">
                        <div className="instructor-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="250">
                            <div className="thumb">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6">
                        <div className="instructor-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="300">
                            <div className="thumb">
                    ...
                    <div className="col-xl-3 col-lg-4 col-md-6">
                        <div className="instructor-wrap-2 aos-init" data-aos="fade-up" data-aos-delay="350">
                            <div className="thumb">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-5">
                        <div className="section-title text-center text-xl-start mb-50 aos-init" data-aos="fade-up"
                             data-aos-delay="200">
                            <div className="sub-title mb-10">
                                <p>Testimonial</p>
                            </div>
                ...
                <div className="row">
                    <div className="col-xl-12 aos-init" data-aos="fade-up" data-aos-delay="300">
                      {/* <TestimonialSlider /> */}
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-xl-12">
                        <div className="video-wrapper">
                            <div className="thumb aos-init" data-aos="fade-up" data-aos-delay="300">
                ...
                <div className="faq-wrapper-2">
                    <div className="row align-items-center">
                        <div className="col-xl-5 col-lg-6 text-xl-start text-center mb-lg-50 mb-md-50 mb-xs-50">
                            <div className="faq-thumb aos-init" data-aos="fade-right" data-aos-delay="200">
        ...
        <div className="blog-section-2 pt-150 pt-lg-120 pt-md-80 pt-xs-50">
            <div className="container">
                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-lg-4 col-md-6">
                        <div className="blog-grid-wrap aos-init" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div className="text">
                                <p>Beginner Diploma In Basic English Grammar is Better Search</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="blog-grid-wrap aos-init" data-aos="fade-up" data-aos-delay="250">
                            <div className="blog-img">
                            ...
                            <h3 className="title">
                                <a href="#">
                                    Join Our Training Course &amp; Online
                                    Build Your Skill.
                                </a>
                            </h3>
                            <div className="text">
                                <p>Beginner Diploma In Basic English Grammar is
                                    Better Search</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                        <div className="blog-grid-wrap aos-init" data-aos="fade-up" data-aos-delay="300">
                            <div className="blog-img">
                    ...
                    <div className="col-xl-12 aos-init" data-aos="fade-up" data-aos-delay="300">
                        <div className="swiper brand-layout-2 swiper-initialized swiper-horizontal swiper-backface-hidden">
                            <div className="swiper-wrapper"
                                 style={{ transform: "translate3d(-540px, 0px, 0px)", transitionDuration: "0ms" }}>
                                <div className="swiper-slide" style={{width: '240px', marginRight: '30px'}}
                                     data-swiper-slide-index="0">
                                    <div className="brand-item">
                                        <img src="assets/img/brand/partner-1.png" alt="thumb" />
                                    </div>
                                </div>
                                <div className="swiper-slide swiper-slide-prev" style={{width: '240px', marginRight: '30px'}}
                                     data-swiper-slide-index="1">
                                    <div className="brand-item">
                                        <img src="assets/img/brand/partner-2.png" alt="thumb" />
                                    </div>
                                </div>
                                <div className="swiper-slide swiper-slide-active" style={{width: '240px', marginRight: '30px'}}
                                     data-swiper-slide-index="2">
                                    <div className="brand-item">
                                        <img src="assets/img/brand/partner-3.png" alt="thumb" />
                                    </div>
                                </div>
                                <div className="swiper-slide swiper-slide-next" style={{width: '240px', marginRight: '30px'}}
